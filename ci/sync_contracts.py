...
LIMITS = (
    ...
    ("MAX_ATLAS_PAGES", "maxAtlasPages"),
    ("MAX_ATLAS_AGGREGATE_BYTES", "maxAtlasAggregateBytes"),
    ("MAX_SPRITE_SOURCE_BYTES", "maxSpriteSourceBytes"),
    ("MAX_SPRITE_SOURCE_DIMENSION", "maxSpriteSourceDimension"),
    ("MAX_SPRITE_SOURCE_DECODED_PIXELS", "maxSpriteSourceDecodedPixels"),
    ("MAX_SPRITE_CATALOG_ENTRIES", "maxSpriteCatalogEntries"),
    ("MAX_SPRITE_CATALOG_BYTES", "maxSpriteCatalogBytes"),
    ("MAX_SPRITE_CATALOG_DECODED_PIXELS", "maxSpriteCatalogDecodedPixels"),
    ("MAX_PREPARED_TILE_DECODED_PIXELS", "maxPreparedTileDecodedPixels"),
